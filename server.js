...
const {allTodos,allTodosCombo, addMed , searchMedicamento, getMedicamentoDetalle, updateTask, deleteTask} = require('./controllers/medicamentosController');
